...
const TalkToCounsellor = () => {
  ...
  return(
    ...
    <div id="upper">
      ...
      <p>Connect with our free counselling services. All sessions are completely confidential<br></br> and available at no cost to students.</p>
    </div>
    ...
    <div className="cards">
      <div id="card1">
       ...
       <span id="subdetail">
        <img id="clock" src="/TalkToCouncellorclock.png"></img> <p>50 minutes</p>
      </span>
      <span id="subdetail2">
        <img id="clock" src="/TalkToCouncellorcalender.png"></img> <p>Mon-Fri 9AM-5PM</p>
      </span>
      </div>
      ...
      <div id="card1">
        <img src="/TalkToPage.png"/>
        <h3>Group Therapy</h3>
       <p>Stuctured group sessions focused on specific mental health topics</p>
       <span id="subdetail">
        <img id="clock" src="/TalkToCouncellorclock.png"></img> <p>75 minutes</p>
      </span>
      <span id="subdetail2">
        <img id="clock" src="/TalkToCouncellorcalender.png"></img> <p>Weekly sessions</p>
      </span>
      </div>
      <div id="card3">
        ...
        <span id="subdetail">
        <img id="clock" src="/TalkToCouncellorclock.png"></img> <p>As needed</p>
      </span>
      <span id="subdetail2">
        <img id="clock" src="/TalkToCouncellorcalender.png"></img> <p>24/7 hotline</p>
      </span>
      </div>
    </div>
    ...
    <div className="Privacy">
      <img src="/TalkToCounsellorSheld.png"></img>
      <h3>Your Privacy is Protected</h3>
      <p>All appointments are completely confidential. We follow strict HIPAA guidelines to ensure your privacy and security.</p>
    </div>
    </div>
    <div>
