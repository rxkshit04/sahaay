  ...
  return (
    <div className="Resource_container">
      <div id="upper">
        ...
        <p>
          Curated content to support your mental health journey, including articles, videos, <br />
          guided meditations, and tools available in multiple languages.
        </p>
      </div>
      ...
      <div className="Resources_card_main">
        <div className="Resource_cards">
          ...
          <div id="Resource_card1">
            ...
            <span>
              <p id="dot">•</p><p id="sub_para">24 resources available</p>
            </span>
          </div>
          ...
          <div id="Resource_card1">
            ...
            <span>
              <p id="dot">•</p><p id="sub_para">18 resources available</p>
            </span>
          </div>
          ...
          <div id="Resource_card1">
            ...
            <span>
              <p id="dot">•</p><p id="sub_para">15 resources available</p>
            </span>
          </div>
          ...
          <div id="Resource_card1">
            ...
            <span>
              <p id="dot">•</p><p id="sub_para">12 resources available</p>
            </span>
          </div>
          ...
          <div id="Resource_card1">
            ...
            <span>
              <p id="dot">•</p><p id="sub_para">8 resources available</p>
            </span>
          </div>
          ...
          <div id="card3">
            ...
            <span>
              <p id="dot">•</p><p id="sub_para">32 resources available</p>
            </span>
          </div>
